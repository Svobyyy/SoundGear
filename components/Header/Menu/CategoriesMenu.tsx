...
export default function CategoriesMenu({ setMenu, menu }: Props) {
  return (
    <section
      className={`absolute left-0 top-[90px] z-20 inline-block w-full rounded-b-lg bg-white pb-[35px] pt-[87px] md:pb-[67px] md:pt-[108px] tab:hidden ${showMenu(menu)} flex items-center justify-center transition-all`}
    >
