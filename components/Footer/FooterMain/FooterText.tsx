...
export default function FooterText() {
  return (
    <div className="tab:mt-9a mt-12 flex w-full max-w-[1110px] items-end justify-between gap-10 sm:mt-8">
      <p className="z-50 max-w-[680px] flex-1 text-center opacity-50 sm:text-start tab:max-w-[540px]">
      ...
      <ul className="z-50 hidden h-[24px] gap-[16px] transition-colors tab:flex">
