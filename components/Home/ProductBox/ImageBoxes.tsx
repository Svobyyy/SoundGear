...
const primaryBoxStyle =
  "absolute top-[55px] z-[1] sm:top-[52px] lg:bottom-[-20px] lg:left-[60px] lg:top-[80px] main:left-[120px]";
    ...
    <>
      {desktop && (
        <Image
          ...
          className={`hidden ${primary ? `${primaryBoxStyle} lg:inline-block h-[510px]` : "absolute bottom-0 left-0 hidden h-full object-cover maintab:inline-block"}`}
          src={`${desktop?.source}`}
        />
      )}
      ...
      {mobile && (
        <Image
          ...
          className={`${primary ? `${primaryBoxStyle} sm:hidden h-[204px]` : "absolute bottom-0 left-0 h-full object-cover mob:hidden"}`}
          src={`${mobile?.source}`}
        />
      )}
    </>
